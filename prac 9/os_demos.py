...
def demo_walk():
    ...
    for directory_name, subdirectories, filenames in os.walk('.'):
        ...
        os.path.join('F:\CP1404pracs\prac 9\Lyrics\Lyrics\Christmas')
            for filenames in s.rename(os.path.join('F:\CP1404pracs\prac 9\Lyrics\Lyrics\Christmas' , 'F:\CP1404pracs\prac 9\Lyrics\Lyrics\Christmas\temp')):
